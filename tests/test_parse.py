...
class SlideMakerTests(unittest.TestCase):
    ...
    def test_simple(self):
        ...
        self.assertEqual(
            etree.tostring(tree),
            (
                b'<document source="&lt;string&gt;"><step step="0" class="step step-level-1">'
                ...
                b'</section></step><step step="1" class="step step-level-1"><section '
    ...
    def test_advanced(self):
        ...
        target = (
            ...
            b'title and a transition-duration.</paragraph><step step="0" class="step '
            b'step-level-1" data-x="1000" data-y="1600"><section '
            ...
            b'step="1" class="step step-level-1" id="name-this-step" '
            ...
            b'</section></step><step step="2" class="step step-level-1">'
            ...
            b'</step><step step="4" class="step step-level-1"><section ids="character-sets" '
    ...
    def test_presenter_notes(self):
        ...
        target = (
            ...
            b'title</title><step step="0" '
            b'class="step step-level-1"><section ids="hovercrafts-presenter-notes" '
            ...
            b'</step><step step="1" class="step step-level-1"><image '
    ...
    def test_transition_levels(self):
        ...
        target = (
            b'<document source="&lt;string&gt;"><paragraph>Intro</paragraph>'
            b'<step step="0" class="step step-level-1"><paragraph>Level 1</paragraph></step>'
            b'<step step="1" class="step step-level-1"><paragraph>Level 1</paragraph>'
            b'<step step="2" class="step step-level-2"><paragraph>Level 2</paragraph>'
            b'<step step="3" class="step step-level-3"><paragraph>Level 3</paragraph></step>'
            b'</step><step step="4" class="step step-level-2"><paragraph>Level 2</paragraph>'
            b'<step step="5" class="step step-level-3"><paragraph>Level 3</paragraph></step>'
            b'</step></step><step step="6" class="step step-level-1"><paragraph>Level 1'
