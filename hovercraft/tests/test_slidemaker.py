...
class SlideMakerTests(unittest.TestCase):
    ...
    def test_advanced(self): 
        ...
        self.assertEqual(etree.tostring(tree), b'<document '\
        b'source="&lt;string&gt;" title="Presentation title" '\
        ...
        b'like <emphasis>italic</emphasis>, and <strong>bold</strong>.</paragraph>'\
        b'<bullet_list bullet="*"><list_item><paragraph>We can '\
        ...
        b'step="3"><image '\
        b'uri="images/python-logo-master-v3-TM.jpg"/></step><step '\
        b'step="4"><section ids="character-sets" names="character\\ '\
